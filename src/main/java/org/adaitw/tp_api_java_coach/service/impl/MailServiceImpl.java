...
public class MailServiceImpl implements MailService<MailDTO, UsuarioEntity> {
    ...
    @Override
    public MailDTO mailConsejo(String email) throws MessagingException {
        ...
        logger.info("Cuerpo del mail: " + mailDTO);
    ...
    public MailDTO enviarMailConsejo(MailDTO mailDTO) throws MessagingException {
        ...
        MimeMessage msg = mailSender.createMimeMessage();
            ...
            mailSender.send(msg);
            logger.info("Mensaje enviado: " + mailDTO);
        return mailDTO;
    }
}
