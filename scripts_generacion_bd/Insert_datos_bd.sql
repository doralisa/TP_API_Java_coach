...
insert into ejemplos (contenido_ejemplo,descripcion_ejemplo,id_concepto)
	values ('Metodos Get','public String getName() { return name; }',1),
	('Metodo Set','public void setName(){ name = newName;}',1),
	('En la línea 4,  sólo hay un elemento en el array y el índice 1 no está permitido. Java mostró la excepción:\\n ZooException in thread "main" \\n java.lang.ArrayIndexOutOfBoundsException: 1 \\n at mainmethod.Zoo.main(Zoo.java:7)','El rol de las excepciones',3),
	('import java.util.*','Comodines',2);
...
values ('1)Son las características que da la clase', 1, 0),
('2)Son las operaciones que realiza la clase', 1, 0),
('3)Son las instancias de una clase', 1, 1),
('1)Las excepciones de tiempo de ejecución son lo mismo que las excepciones chequeadas', 2, 0),
('2) Las excepciones de tiempo de ejecución son lo mismo que las excepciones no chequeadas', 2, 0),
('3) Podés declarar únicamente excepciones no chequeadas', 2, 1);